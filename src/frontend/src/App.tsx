...
import { OtpHistory } from './components/history/OtpHistory';
import { AccessTokenManager } from './components/mcp/AccessTokenManager';
import clsx from 'clsx';
import { useMcp } from './hooks/useMcp';
import { Dashboard } from './components/dashboard/Dashboard';
import { Tester } from './components/functions/Tester';
import { LogViewer } from './components/functions/LogViewer';
import { Login } from './components/auth/Login';
import { LoginHistViewer } from './components/history/LoginHistViewer';
import { Users } from './components/system/Users';
import { UsageHistory } from './components/mcp/UsageHistory';
import { SchemaManager } from './components/system/SchemaManager';
import { LimitManagement } from './components/mcp/LimitManagement';
import { CustomTools } from './components/mcp/CustomTools';
import { MyPage } from './components/auth/MyPage';
import { SystemConfig } from './components/system/SystemConfig';
import { EmailSender } from './components/functions/EmailSender';
import { EmailHistory } from './components/history/EmailHistory';
import { FileManager } from './components/functions/FileManager';
import { OpenApiManager } from './components/openapi/OpenApiManager';
import { OpenApiMetaManager } from './components/openapi/OpenApiMetaManager';
import OpenApiStats from './components/openapi/OpenApiStats';
import OpenApiLimit from './components/openapi/OpenApiLimit';
import DbBackupManager from './components/system/DbBackupManager';
import SchedulerManager from './components/system/SchedulerManager';
import { NotificationManagement } from './components/history/NotificationManagement';
...
import {
  ...
  Menu, Sun, Moon, ShieldCheck, Bell
} from 'lucide-react';
...
function App() {
  ...
  type ActiveView = 'dashboard' | 'tester' | 'logs' | 'history' | 'users'
    ...
    | 'openapi' | 'openapi-meta' | 'openapi-stats' | 'openapi-limits' | 'db-backup' | 'scheduler' | 'otp-history' | 'notifications';
