        ...
        <div className="h-[calc(100vh-8rem)] flex flex-col space-y-4 font-pretendard">
            ...
            {selectedJson !== null && (
                <div className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 transition-all">
                    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden animate-fade-in transition-colors duration-300">
                        <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-800 flex justify-between items-center bg-gray-50 dark:bg-slate-800/50">
                            <h3 className="text-lg font-bold text-gray-800 dark:text-slate-100">{modalTitle}</h3>
                            <button
                        ...
                        <div className="flex-1 overflow-auto p-6">
                            <pre className="bg-gray-900 dark:bg-black text-green-400 p-4 rounded-lg text-sm font-mono whitespace-pre-wrap break-all shadow-inner border border-gray-800 dark:border-slate-700">
                                {selectedJson}
                            </pre>
                        </div>
                        <div className="px-6 py-4 border-t border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-800/50 text-right">
                            <button
                                onClick={() => setSelectedJson(null)}
