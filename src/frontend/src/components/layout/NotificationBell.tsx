        ...
        <div className="p-6 space-y-4">
          <div>
            <div className="flex items-center space-x-2 text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">
              ...
              <span>{t('nbSender', { sender: notification.send_user_nm || t('nbSystem') })}</span>
            </div>
          ...
          <div className="max-h-[400px] overflow-y-auto no-scrollbar">
            {notifications.length > 0 ? (
              ...
              <div className="p-12 text-center text-gray-400 dark:text-slate-500">
                ...
                <p className="text-sm">{t('nbNoNotifications')}</p>
              </div>
            )}
          </div>
